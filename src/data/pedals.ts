...
export const PEDALS: Pedal[] = [
  {
    ...
    manual: {
      title: "Origin Effects: Cali76 Stacked Compressor product page",
  ...
  },
  {
    ...
    power: "9 V DC centre-negative, no battery. DigiTech's own manual gives 258 mA typical at 9 V, which is high for a pedal this size and worth respecting when you plan the board.",
    mA: 258,
  ...
  },
  {
    ...
    power: "9 V DC centre-negative. Lichtlaerm's product page lists 60 mA, which makes it the cheapest thing on this board to run.",
    mA: 60,
  ...
  },
  {
    ...
    manual: {
      title: "Old Blood Noise Endeavors: Parting product page",
  ...
  },
  {
    ...
    power:
      "9 V DC centre-negative, no battery. Published figures disagree: Chase Bliss lists about 200 mA, and third-party databases list 270 mA. The budget below uses 270, because under-provisioning a supply is the expensive mistake.",
    mA: 270,
  ...
  },
  {
    ...
    manual: {
      title: "Cornerstone: Nucleo product page",
